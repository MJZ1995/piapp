...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.noTools": "Chat only, no tools",
    ...
    "chat.voiceSend": "Transcribe and send",
    ...
    "subagent.renameTab": "Double-click to rename",
    "subagent.readonlyInput": "Subagent is one-shot; follow-up chat comes in Phase 2",
    "subagent.empty": "No output yet...",
    "subagent.usage.turns": "{count} turns",
    "subagent.usage.input": "{count} in",
    "subagent.usage.output": "{count} out",
    "i18n.close": "Close",
    "i18n.copy": "Copy",
    "i18n.copied": "Copied",
    "i18n.cancel": "Cancel",
