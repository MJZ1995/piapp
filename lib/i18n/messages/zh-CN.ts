...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.voiceCancel": "取消录音",
    "chat.voiceStop": "停止并转写",
    "chat.voiceSend": "转写并发送",
    ...
    "subagent.mainTab": "主进程",
    "subagent.status.running": "运行中",
    "subagent.status.done": "已完成",
    "subagent.status.error": "失败",
    "subagent.status.aborted": "已中止",
    "subagent.closeTab": "关闭标签",
    "subagent.renameTab": "双击重命名",
    "subagent.readonlyInput": "子 agent 为一次性会话，继续对话将在二期开放",
    "subagent.empty": "暂无输出...",
    "subagent.usage.turns": "{count} 轮",
    "subagent.usage.input": "输入 {count}",
    "subagent.usage.output": "输出 {count}",
