...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.chatOnly": "僅聊天",
    "chat.noTools": "僅對話，不使用工具",
    "chat.emptyGreeting": "今日事，我來幫。",
    "chat.addImage": "新增圖片",
    "chat.atFile": "@ 引用檔案",
    "chat.sessionSettings": "會話設定",
    "chat.mcpServers": "MCP 伺服器",
    "chat.mode": "模式",
    "chat.modeDefault": "預設",
    "chat.mcpEmpty": "未設定 MCP 伺服器",
    "chat.mcpToggleHint": "切換後於新會話生效",
    "chat.loading": "載入中…",
    "chat.noSkills": "無可用技能",
    "chat.voiceError": "語音轉寫失敗，請重試",
    "chat.voiceUnsupported": "目前環境不支援麥克風",
    "chat.voiceInput": "語音輸入",
    "chat.voiceCancel": "取消錄音",
    "chat.voiceStop": "停止並轉寫",
    "chat.voiceSend": "轉寫並傳送",
    "chat.voiceTranscribing": "轉寫中…",
    "subagent.mainTab": "主程序",
    "subagent.status.running": "執行中",
    "subagent.status.done": "已完成",
    "subagent.status.error": "失敗",
    "subagent.status.aborted": "已中止",
    "subagent.closeTab": "關閉標籤",
    "subagent.renameTab": "雙擊重新命名",
    "subagent.readonlyInput": "子 agent 為一次性會話，後續對話將於第二階段開放",
    "subagent.empty": "暫無輸出...",
    "subagent.usage.turns": "{count} 輪",
    "subagent.usage.input": "輸入 {count}",
    "subagent.usage.output": "輸出 {count}",
